...
> CellsCloudResponse cells_charts_put_worksheet_chart_legend(name, sheet_name, chart_index, folder=folder, storage_name=storage_name)
...
try: 
    # Show legend in chart
    api_response = api_instance.cells_charts_put_worksheet_chart_legend(name, sheet_name, chart_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_charts_put_worksheet_chart_legend: %s\n" % e)
```
...
> TitleResponse cells_charts_put_worksheet_chart_title(name, sheet_name, chart_index, title=title, folder=folder, storage_name=storage_name)
...
try: 
    # Add chart title / Set chart title visible
    api_response = api_instance.cells_charts_put_worksheet_chart_title(name, sheet_name, chart_index, title=title, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_charts_put_worksheet_chart_title: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_delete_worksheet_conditional_formatting(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    # Remove conditional formatting
    api_response = api_instance.cells_conditional_formattings_delete_worksheet_conditional_formatting(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_delete_worksheet_conditional_formatting: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_delete_worksheet_conditional_formatting_area(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Remove cell area from conditional formatting.
    api_response = api_instance.cells_conditional_formattings_delete_worksheet_conditional_formatting_area(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_delete_worksheet_conditional_formatting_area: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_delete_worksheet_conditional_formattings(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Clear all condition formattings
    api_response = api_instance.cells_conditional_formattings_delete_worksheet_conditional_formattings(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_delete_worksheet_conditional_formattings: %s\n" % e)
```
...
> ConditionalFormattingResponse cells_conditional_formattings_get_worksheet_conditional_formatting(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    # Get conditional formatting
    api_response = api_instance.cells_conditional_formattings_get_worksheet_conditional_formatting(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_get_worksheet_conditional_formatting: %s\n" % e)
```
...
> ConditionalFormattingsResponse cells_conditional_formattings_get_worksheet_conditional_formattings(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get conditional formattings 
    api_response = api_instance.cells_conditional_formattings_get_worksheet_conditional_formattings(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_get_worksheet_conditional_formattings: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_put_worksheet_conditional_formatting(name, sheet_name, cell_area, format_condition=format_condition, folder=folder, storage_name=storage_name)
...
try: 
    # Add a condition formatting.
    api_response = api_instance.cells_conditional_formattings_put_worksheet_conditional_formatting(name, sheet_name, cell_area, format_condition=format_condition, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_conditional_formattings_put_worksheet_format_condition(name, sheet_name, index, cell_area, type, operator_type, formula1, formula2, folder=folder, storage_name=storage_name)
...
try: 
    # Add a format condition.
    api_response = api_instance.cells_conditional_formattings_put_worksheet_format_condition(name, sheet_name, index, cell_area, type, operator_type, formula1, formula2, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_put_worksheet_format_condition: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_put_worksheet_format_condition_area(name, sheet_name, index, cell_area, folder=folder, storage_name=storage_name)
...
try: 
    # add a cell area for format condition             
    api_response = api_instance.cells_conditional_formattings_put_worksheet_format_condition_area(name, sheet_name, index, cell_area, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_put_worksheet_format_condition_area: %s\n" % e)
```
...
> CellsCloudResponse cells_conditional_formattings_put_worksheet_format_condition_condition(name, sheet_name, index, type, operator_type, formula1, formula2, folder=folder, storage_name=storage_name)
...
try: 
    # Add a condition for format condition.
    api_response = api_instance.cells_conditional_formattings_put_worksheet_format_condition_condition(name, sheet_name, index, type, operator_type, formula1, formula2, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_conditional_formattings_put_worksheet_format_condition_condition: %s\n" % e)
```
...
try: 
    # Delete worksheet columns.
    api_response = api_instance.cells_delete_worksheet_columns(name, sheet_name, column_index, columns, update_reference, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_delete_worksheet_row(name, sheet_name, row_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet row.
    api_response = api_instance.cells_delete_worksheet_row(name, sheet_name, row_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_delete_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder, storage_name=storage_name)
...
try: 
    # Delete several worksheet rows.
    api_response = api_instance.cells_delete_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> object cells_get_cell_html_string(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read cell data by cell's name.
    api_response = api_instance.cells_get_cell_html_string(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> object cells_get_worksheet_cell(name, sheet_name, cell_or_method_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read cell data by cell's name.
    api_response = api_instance.cells_get_worksheet_cell(name, sheet_name, cell_or_method_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> StyleResponse cells_get_worksheet_cell_style(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read cell's style info.
    api_response = api_instance.cells_get_worksheet_cell_style(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsResponse cells_get_worksheet_cells(name, sheet_name, offest=offest, count=count, folder=folder, storage_name=storage_name)
...
try: 
    # Get cells info.
    api_response = api_instance.cells_get_worksheet_cells(name, sheet_name, offest=offest, count=count, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> ColumnResponse cells_get_worksheet_column(name, sheet_name, column_index, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet column data by column's index.
    api_response = api_instance.cells_get_worksheet_column(name, sheet_name, column_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> ColumnsResponse cells_get_worksheet_columns(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet columns info.
    api_response = api_instance.cells_get_worksheet_columns(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> RowResponse cells_get_worksheet_row(name, sheet_name, row_index, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet row data by row's index.
    api_response = api_instance.cells_get_worksheet_row(name, sheet_name, row_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> RowsResponse cells_get_worksheet_rows(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet rows info.
    api_response = api_instance.cells_get_worksheet_rows(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_hypelinks_delete_worksheet_hyperlink(name, sheet_name, hyperlink_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet hyperlink by index.
    api_response = api_instance.cells_hypelinks_delete_worksheet_hyperlink(name, sheet_name, hyperlink_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_delete_worksheet_hyperlink: %s\n" % e)
```
...
> CellsCloudResponse cells_hypelinks_delete_worksheet_hyperlinks(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete all hyperlinks in worksheet.
    api_response = api_instance.cells_hypelinks_delete_worksheet_hyperlinks(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_delete_worksheet_hyperlinks: %s\n" % e)
```
...
> HyperlinkResponse cells_hypelinks_get_worksheet_hyperlink(name, sheet_name, hyperlink_index, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet hyperlink by index.
    api_response = api_instance.cells_hypelinks_get_worksheet_hyperlink(name, sheet_name, hyperlink_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_get_worksheet_hyperlink: %s\n" % e)
```
...
> HyperlinksResponse cells_hypelinks_get_worksheet_hyperlinks(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet hyperlinks.
    api_response = api_instance.cells_hypelinks_get_worksheet_hyperlinks(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_get_worksheet_hyperlinks: %s\n" % e)
```
...
> HyperlinkResponse cells_hypelinks_post_worksheet_hyperlink(name, sheet_name, hyperlink_index, hyperlink=hyperlink, folder=folder, storage_name=storage_name)
...
try: 
    # Update worksheet hyperlink by index.
    api_response = api_instance.cells_hypelinks_post_worksheet_hyperlink(name, sheet_name, hyperlink_index, hyperlink=hyperlink, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_post_worksheet_hyperlink: %s\n" % e)
```
...
> HyperlinkResponse cells_hypelinks_put_worksheet_hyperlink(name, sheet_name, first_row, first_column, total_rows, total_columns, address, folder=folder, storage_name=storage_name)
...
try: 
    # Add worksheet hyperlink.
    api_response = api_instance.cells_hypelinks_put_worksheet_hyperlink(name, sheet_name, first_row, first_column, total_rows, total_columns, address, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_hypelinks_put_worksheet_hyperlink: %s\n" % e)
```
...
> CellsCloudResponse cells_list_objects_delete_worksheet_list_object(name, sheet_name, list_object_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet list object by index
    api_response = api_instance.cells_list_objects_delete_worksheet_list_object(name, sheet_name, list_object_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_delete_worksheet_list_object: %s\n" % e)
```
...
> CellsCloudResponse cells_list_objects_delete_worksheet_list_objects(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet list objects
    api_response = api_instance.cells_list_objects_delete_worksheet_list_objects(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_delete_worksheet_list_objects: %s\n" % e)
```
...
> ListObjectResponse cells_list_objects_get_worksheet_list_object(name, sheet_name, listobjectindex, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet list object info by index.
    api_response = api_instance.cells_list_objects_get_worksheet_list_object(name, sheet_name, listobjectindex, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> ListObjectsResponse cells_list_objects_get_worksheet_list_objects(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet listobjects info.
    api_response = api_instance.cells_list_objects_get_worksheet_list_objects(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_get_worksheet_list_objects: %s\n" % e)
```
...
> CellsCloudResponse cells_list_objects_post_worksheet_list_object(name, sheet_name, list_object_index, list_object=list_object, folder=folder, storage_name=storage_name)
...
try: 
    # Update  list object 
    api_response = api_instance.cells_list_objects_post_worksheet_list_object(name, sheet_name, list_object_index, list_object=list_object, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_post_worksheet_list_object: %s\n" % e)
```
...
> CellsCloudResponse cells_list_objects_post_worksheet_list_object_convert_to_range(name, sheet_name, list_object_index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_list_objects_post_worksheet_list_object_convert_to_range(name, sheet_name, list_object_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_list_objects_post_worksheet_list_object_sort_table(name, sheet_name, list_object_index, data_sorter=data_sorter, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_list_objects_post_worksheet_list_object_sort_table(name, sheet_name, list_object_index, data_sorter=data_sorter, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_post_worksheet_list_object_sort_table: %s\n" % e)
```
...
> CellsCloudResponse cells_list_objects_post_worksheet_list_object_summarize_with_pivot_table(name, sheet_name, list_object_index, destsheet_name, request=request, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_list_objects_post_worksheet_list_object_summarize_with_pivot_table(name, sheet_name, list_object_index, destsheet_name, request=request, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_post_worksheet_list_object_summarize_with_pivot_table: %s\n" % e)
```
...
> ListObjectResponse cells_list_objects_put_worksheet_list_object(name, sheet_name, start_row, start_column, end_row, end_column, has_headers=has_headers, list_object=list_object, folder=folder, storage_name=storage_name)
...
list_object = asposecellscloud.ListObject() # ListObject | List Object (optional)
folder = 'folder_example' # str | Document's folder. (optional)
storage_name = 'storage_name_example' # str | storage name. (optional)

try: 
    # Add a list object into worksheet.
    api_response = api_instance.cells_list_objects_put_worksheet_list_object(name, sheet_name, start_row, start_column, end_row, end_column, has_headers=has_headers, list_object=list_object, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_list_objects_put_worksheet_list_object: %s\n" % e)
```
...
> CellsCloudResponse cells_ole_objects_delete_worksheet_ole_object(name, sheet_name, ole_object_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete OLE object.
    api_response = api_instance.cells_ole_objects_delete_worksheet_ole_object(name, sheet_name, ole_object_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ole_objects_delete_worksheet_ole_object: %s\n" % e)
```
...
> CellsCloudResponse cells_ole_objects_delete_worksheet_ole_objects(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete all OLE objects.
    api_response = api_instance.cells_ole_objects_delete_worksheet_ole_objects(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ole_objects_delete_worksheet_ole_objects: %s\n" % e)
```
...
> file cells_ole_objects_get_worksheet_ole_object(name, sheet_name, object_number, format=format, folder=folder, storage_name=storage_name)
...
try: 
    # Get OLE object info.
    api_response = api_instance.cells_ole_objects_get_worksheet_ole_object(name, sheet_name, object_number, format=format, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ole_objects_get_worksheet_ole_object: %s\n" % e)
```
...
> OleObjectsResponse cells_ole_objects_get_worksheet_ole_objects(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet OLE objects info.
    api_response = api_instance.cells_ole_objects_get_worksheet_ole_objects(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_ole_objects_post_update_worksheet_ole_object(name, sheet_name, ole_object_index, ole=ole, folder=folder, storage_name=storage_name)
...
try: 
    # Update OLE object.
    api_response = api_instance.cells_ole_objects_post_update_worksheet_ole_object(name, sheet_name, ole_object_index, ole=ole, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> OleObjectResponse cells_ole_objects_put_worksheet_ole_object(name, sheet_name, ole_object=ole_object, upper_left_row=upper_left_row, upper_left_column=upper_left_column, height=height, width=width, ole_file=ole_file, image_file=image_file, folder=folder, storage_name=storage_name)
...
try: 
    # Add OLE object
    api_response = api_instance.cells_ole_objects_put_worksheet_ole_object(name, sheet_name, ole_object=ole_object, upper_left_row=upper_left_row, upper_left_column=upper_left_column, height=height, width=width, ole_file=ole_file, image_file=image_file, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ole_objects_put_worksheet_ole_object: %s\n" % e)
```
...
> CellsCloudResponse cells_page_breaks_delete_horizontal_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_delete_horizontal_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_page_breaks_delete_horizontal_page_breaks(name, sheet_name, row=row, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_delete_horizontal_page_breaks(name, sheet_name, row=row, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_delete_horizontal_page_breaks: %s\n" % e)
```
...
> CellsCloudResponse cells_page_breaks_delete_vertical_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_delete_vertical_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_delete_vertical_page_break: %s\n" % e)
```
...
> CellsCloudResponse cells_page_breaks_delete_vertical_page_breaks(name, sheet_name, column=column, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_delete_vertical_page_breaks(name, sheet_name, column=column, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_delete_vertical_page_breaks: %s\n" % e)
```
...
> HorizontalPageBreakResponse cells_page_breaks_get_horizontal_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_get_horizontal_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_get_horizontal_page_break: %s\n" % e)
```
...
> HorizontalPageBreaksResponse cells_page_breaks_get_horizontal_page_breaks(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_get_horizontal_page_breaks(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> VerticalPageBreakResponse cells_page_breaks_get_vertical_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_get_vertical_page_break(name, sheet_name, index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_get_vertical_page_break: %s\n" % e)
```
...
> VerticalPageBreaksResponse cells_page_breaks_get_vertical_page_breaks(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_get_vertical_page_breaks(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_get_vertical_page_breaks: %s\n" % e)
```
...
> CellsCloudResponse cells_page_breaks_put_horizontal_page_break(name, sheet_name, cellname=cellname, row=row, column=column, start_column=start_column, end_column=end_column, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_put_horizontal_page_break(name, sheet_name, cellname=cellname, row=row, column=column, start_column=start_column, end_column=end_column, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_put_horizontal_page_break: %s\n" % e)
```
...
> CellsCloudResponse cells_page_breaks_put_vertical_page_break(name, sheet_name, cellname=cellname, column=column, row=row, start_row=start_row, end_row=end_row, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_page_breaks_put_vertical_page_break(name, sheet_name, cellname=cellname, column=column, row=row, start_row=start_row, end_row=end_row, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_breaks_put_vertical_page_break: %s\n" % e)
```
...
> CellsCloudResponse cells_page_setup_delete_header_footer(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # clear header footer
    api_response = api_instance.cells_page_setup_delete_header_footer(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_delete_header_footer: %s\n" % e)
```
...
> PageSectionsResponse cells_page_setup_get_footer(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # get page footer information
    api_response = api_instance.cells_page_setup_get_footer(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_get_footer: %s\n" % e)
```
...
> PageSectionsResponse cells_page_setup_get_header(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # get page header information
    api_response = api_instance.cells_page_setup_get_header(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_get_header: %s\n" % e)
```
...
> PageSetupResponse cells_page_setup_get_page_setup(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get Page Setup information.             
    api_response = api_instance.cells_page_setup_get_page_setup(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_get_page_setup: %s\n" % e)
```
...
> CellsCloudResponse cells_page_setup_post_footer(name, sheet_name, section, script, is_first_page, folder=folder, storage_name=storage_name)
...
try: 
    # update  page footer information 
    api_response = api_instance.cells_page_setup_post_footer(name, sheet_name, section, script, is_first_page, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_post_footer: %s\n" % e)
```
...
> CellsCloudResponse cells_page_setup_post_header(name, sheet_name, section, script, is_first_page, folder=folder, storage_name=storage_name)
...
try: 
    # update  page header information 
    api_response = api_instance.cells_page_setup_post_header(name, sheet_name, section, script, is_first_page, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_post_header: %s\n" % e)
```
...
> CellsCloudResponse cells_page_setup_post_page_setup(name, sheet_name, page_setup=page_setup, folder=folder, storage_name=storage_name)
...
try: 
    # Update Page Setup information.
    api_response = api_instance.cells_page_setup_post_page_setup(name, sheet_name, page_setup=page_setup, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_page_setup_post_page_setup: %s\n" % e)
```
...
> CellsCloudResponse cells_pictures_delete_worksheet_picture(name, sheet_name, picture_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete a picture object in worksheet
    api_response = api_instance.cells_pictures_delete_worksheet_picture(name, sheet_name, picture_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_pictures_delete_worksheet_pictures(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete all pictures in worksheet.
    api_response = api_instance.cells_pictures_delete_worksheet_pictures(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pictures_delete_worksheet_pictures: %s\n" % e)
```
...
> file cells_pictures_get_worksheet_picture(name, sheet_name, picture_index, format=format, folder=folder, storage_name=storage_name)
...
try: 
    # GRead worksheet picture by number.
    api_response = api_instance.cells_pictures_get_worksheet_picture(name, sheet_name, picture_index, format=format, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pictures_get_worksheet_picture: %s\n" % e)
```
...
> PicturesResponse cells_pictures_get_worksheet_pictures(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet pictures.
    api_response = api_instance.cells_pictures_get_worksheet_pictures(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> PictureResponse cells_pictures_post_worksheet_picture(name, sheet_name, picture_index, picture=picture, folder=folder, storage_name=storage_name)
...
try: 
    # Update worksheet picture by index.
    api_response = api_instance.cells_pictures_post_worksheet_picture(name, sheet_name, picture_index, picture=picture, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pictures_post_worksheet_picture: %s\n" % e)
```
...
> PicturesResponse cells_pictures_put_worksheet_add_picture(name, sheet_name, picture=picture, upper_left_row=upper_left_row, upper_left_column=upper_left_column, lower_right_row=lower_right_row, lower_right_column=lower_right_column, picture_path=picture_path, folder=folder, storage_name=storage_name)
...
try: 
    # Add a new worksheet picture.
    api_response = api_instance.cells_pictures_put_worksheet_add_picture(name, sheet_name, picture=picture, upper_left_row=upper_left_row, upper_left_column=upper_left_column, lower_right_row=lower_right_row, lower_right_column=lower_right_column, picture_path=picture_path, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pictures_put_worksheet_add_picture: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_delete_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_type, request=request, folder=folder, storage_name=storage_name)
...
try: 
    # Delete pivot field into into pivot table
    api_response = api_instance.cells_pivot_tables_delete_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_type, request=request, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_delete_pivot_table_field: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_delete_worksheet_pivot_table(name, sheet_name, pivot_table_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet pivot table by index
    api_response = api_instance.cells_pivot_tables_delete_worksheet_pivot_table(name, sheet_name, pivot_table_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_delete_worksheet_pivot_table: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_delete_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, field_index, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # delete  pivot filter for piovt table             
    api_response = api_instance.cells_pivot_tables_delete_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, field_index, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_delete_worksheet_pivot_table_filter: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_delete_worksheet_pivot_table_filters(name, sheet_name, pivot_table_index, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # delete all pivot filters for piovt table
    api_response = api_instance.cells_pivot_tables_delete_worksheet_pivot_table_filters(name, sheet_name, pivot_table_index, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_delete_worksheet_pivot_table_filters: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_delete_worksheet_pivot_tables(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet pivot tables
    api_response = api_instance.cells_pivot_tables_delete_worksheet_pivot_tables(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_delete_worksheet_pivot_tables: %s\n" % e)
```
...
> PivotFieldResponse cells_pivot_tables_get_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_index, pivot_field_type, folder=folder, storage_name=storage_name)
...
try: 
    # Get pivot field into into pivot table
    api_response = api_instance.cells_pivot_tables_get_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_index, pivot_field_type, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_get_pivot_table_field: %s\n" % e)
```
...
> PivotTableResponse cells_pivot_tables_get_worksheet_pivot_table(name, sheet_name, pivottable_index, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet pivottable info by index.
    api_response = api_instance.cells_pivot_tables_get_worksheet_pivot_table(name, sheet_name, pivottable_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_get_worksheet_pivot_table: %s\n" % e)
```
...
> PivotFilterResponse cells_pivot_tables_get_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, filter_index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_pivot_tables_get_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, filter_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_get_worksheet_pivot_table_filter: %s\n" % e)
```
...
> PivotFiltersResponse cells_pivot_tables_get_worksheet_pivot_table_filters(name, sheet_name, pivot_table_index, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_pivot_tables_get_worksheet_pivot_table_filters(name, sheet_name, pivot_table_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_get_worksheet_pivot_table_filters: %s\n" % e)
```
...
> PivotTablesResponse cells_pivot_tables_get_worksheet_pivot_tables(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet pivottables info.
    api_response = api_instance.cells_pivot_tables_get_worksheet_pivot_tables(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_get_worksheet_pivot_tables: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_post_pivot_table_cell_style(name, sheet_name, pivot_table_index, column, row, style=style, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # Update cell style for pivot table
    api_response = api_instance.cells_pivot_tables_post_pivot_table_cell_style(name, sheet_name, pivot_table_index, column, row, style=style, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_pivot_table_cell_style: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_post_pivot_table_field_hide_item(name, sheet_name, pivot_table_index, pivot_field_type, field_index, item_index, is_hide, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_pivot_tables_post_pivot_table_field_hide_item(name, sheet_name, pivot_table_index, pivot_field_type, field_index, item_index, is_hide, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_pivot_table_field_hide_item: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_post_pivot_table_field_move_to(name, sheet_name, pivot_table_index, field_index, _from, to, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_pivot_tables_post_pivot_table_field_move_to(name, sheet_name, pivot_table_index, field_index, _from, to, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_pivot_table_field_move_to: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_post_pivot_table_style(name, sheet_name, pivot_table_index, style=style, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # Update style for pivot table
    api_response = api_instance.cells_pivot_tables_post_pivot_table_style(name, sheet_name, pivot_table_index, style=style, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_pivot_table_style: %s\n" % e)
```
...
try: 
    # Calculates pivottable's data to cells.
    api_response = api_instance.cells_pivot_tables_post_worksheet_pivot_table_calculate(name, sheet_name, pivot_table_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_worksheet_pivot_table_calculate: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_post_worksheet_pivot_table_move(name, sheet_name, pivot_table_index, row=row, column=column, dest_cell_name=dest_cell_name, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_pivot_tables_post_worksheet_pivot_table_move(name, sheet_name, pivot_table_index, row=row, column=column, dest_cell_name=dest_cell_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_post_worksheet_pivot_table_move: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_put_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_type, request=request, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # Add pivot field into into pivot table
    api_response = api_instance.cells_pivot_tables_put_pivot_table_field(name, sheet_name, pivot_table_index, pivot_field_type, request=request, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_put_pivot_table_field: %s\n" % e)
```
...
> PivotTableResponse cells_pivot_tables_put_worksheet_pivot_table(name, sheet_name, request=request, folder=folder, storage_name=storage_name, source_data=source_data, dest_cell_name=dest_cell_name, table_name=table_name, use_same_source=use_same_source)
...
try: 
    # Add a pivot table into worksheet.
    api_response = api_instance.cells_pivot_tables_put_worksheet_pivot_table(name, sheet_name, request=request, folder=folder, storage_name=storage_name, source_data=source_data, dest_cell_name=dest_cell_name, table_name=table_name, use_same_source=use_same_source)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_put_worksheet_pivot_table: %s\n" % e)
```
...
> CellsCloudResponse cells_pivot_tables_put_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, filter=filter, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
...
try: 
    # Add pivot filter for piovt table index
    api_response = api_instance.cells_pivot_tables_put_worksheet_pivot_table_filter(name, sheet_name, pivot_table_index, filter=filter, need_re_calculate=need_re_calculate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_pivot_tables_put_worksheet_pivot_table_filter: %s\n" % e)
```
...
> CellsCloudResponse cells_post_cell_calculate(name, sheet_name, cell_name, options=options, folder=folder, storage_name=storage_name)
...
try: 
    # Cell calculate formula
    api_response = api_instance.cells_post_cell_calculate(name, sheet_name, cell_name, options=options, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_cell_characters(name, sheet_name, cell_name, options=options, folder=folder, storage_name=storage_name)
...
try: 
    # Set cell characters 
    api_response = api_instance.cells_post_cell_characters(name, sheet_name, cell_name, options=options, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_clear_contents(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder, storage_name=storage_name)
...
try: 
    # Clear cells contents.
    api_response = api_instance.cells_post_clear_contents(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_clear_formats(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder, storage_name=storage_name)
...
try: 
    # Clear cells contents.
    api_response = api_instance.cells_post_clear_formats(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_column_style(name, sheet_name, column_index, style=style, folder=folder, storage_name=storage_name)
...
try: 
    # Set column style
    api_response = api_instance.cells_post_column_style(name, sheet_name, column_index, style=style, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_copy_cell_into_cell(name, dest_cell_name, sheet_name, worksheet, cellname=cellname, row=row, column=column, folder=folder, storage_name=storage_name)
...
try: 
    # Copy cell into cell
    api_response = api_instance.cells_post_copy_cell_into_cell(name, dest_cell_name, sheet_name, worksheet, cellname=cellname, row=row, column=column, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_copy_worksheet_columns(name, sheet_name, source_column_index, destination_column_index, column_number, worksheet=worksheet, folder=folder, storage_name=storage_name)
...
try: 
    # Copy worksheet columns.
    api_response = api_instance.cells_post_copy_worksheet_columns(name, sheet_name, source_column_index, destination_column_index, column_number, worksheet=worksheet, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_copy_worksheet_rows(name, sheet_name, source_row_index, destination_row_index, row_number, worksheet=worksheet, folder=folder, storage_name=storage_name)
...
try: 
    # Copy worksheet rows.
    api_response = api_instance.cells_post_copy_worksheet_rows(name, sheet_name, source_row_index, destination_row_index, row_number, worksheet=worksheet, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_group_worksheet_columns(name, sheet_name, first_index, last_index, hide=hide, folder=folder, storage_name=storage_name)
...
try: 
    # Group worksheet columns.
    api_response = api_instance.cells_post_group_worksheet_columns(name, sheet_name, first_index, last_index, hide=hide, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_group_worksheet_rows(name, sheet_name, first_index, last_index, hide=hide, folder=folder, storage_name=storage_name)
...
try: 
    # Group worksheet rows.
    api_response = api_instance.cells_post_group_worksheet_rows(name, sheet_name, first_index, last_index, hide=hide, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_hide_worksheet_columns(name, sheet_name, start_column, total_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Hide worksheet columns.
    api_response = api_instance.cells_post_hide_worksheet_columns(name, sheet_name, start_column, total_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_hide_worksheet_rows(name, sheet_name, startrow, total_rows, folder=folder, storage_name=storage_name)
...
try: 
    # Hide worksheet rows.
    api_response = api_instance.cells_post_hide_worksheet_rows(name, sheet_name, startrow, total_rows, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_row_style(name, sheet_name, row_index, style=style, folder=folder, storage_name=storage_name)
...
try: 
    # Set row style.
    api_response = api_instance.cells_post_row_style(name, sheet_name, row_index, style=style, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellResponse cells_post_set_cell_html_string(name, sheet_name, cell_name, html_string, folder=folder, storage_name=storage_name)
...
try: 
    # Set htmlstring value into cell
    api_response = api_instance.cells_post_set_cell_html_string(name, sheet_name, cell_name, html_string, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_set_cell_range_value(name, sheet_name, cellarea, value, type, folder=folder, storage_name=storage_name)
...
try: 
    # Set cell range value 
    api_response = api_instance.cells_post_set_cell_range_value(name, sheet_name, cellarea, value, type, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
try: 
    # Set worksheet column width.
    api_response = api_instance.cells_post_set_worksheet_column_width(name, sheet_name, column_index, width, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_ungroup_worksheet_columns(name, sheet_name, first_index, last_index, folder=folder, storage_name=storage_name)
...
try: 
    # Ungroup worksheet columns.
    api_response = api_instance.cells_post_ungroup_worksheet_columns(name, sheet_name, first_index, last_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_ungroup_worksheet_rows(name, sheet_name, first_index, last_index, is_all=is_all, folder=folder, storage_name=storage_name)
...
try: 
    # Ungroup worksheet rows.
    api_response = api_instance.cells_post_ungroup_worksheet_rows(name, sheet_name, first_index, last_index, is_all=is_all, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_unhide_worksheet_columns(name, sheet_name, startcolumn, total_columns, width=width, folder=folder, storage_name=storage_name)
...
try: 
    # Unhide worksheet columns.
    api_response = api_instance.cells_post_unhide_worksheet_columns(name, sheet_name, startcolumn, total_columns, width=width, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_unhide_worksheet_rows(name, sheet_name, startrow, total_rows, height=height, folder=folder, storage_name=storage_name)
...
try: 
    # Unhide worksheet rows.
    api_response = api_instance.cells_post_unhide_worksheet_rows(name, sheet_name, startrow, total_rows, height=height, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> StyleResponse cells_post_update_worksheet_cell_style(name, sheet_name, cell_name, style=style, folder=folder, storage_name=storage_name)
...
try: 
    # Update cell's style.
    api_response = api_instance.cells_post_update_worksheet_cell_style(name, sheet_name, cell_name, style=style, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_update_worksheet_range_style(name, sheet_name, range, style=style, folder=folder, storage_name=storage_name)
...
try: 
    # Update cell's range style.
    api_response = api_instance.cells_post_update_worksheet_range_style(name, sheet_name, range, style=style, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
try: 
    # Update worksheet row.
    api_response = api_instance.cells_post_update_worksheet_row(name, sheet_name, row_index, height=height, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellResponse cells_post_worksheet_cell_set_value(name, sheet_name, cell_name, value=value, type=type, formula=formula, folder=folder, storage_name=storage_name)
...
try: 
    # Set cell value.
    api_response = api_instance.cells_post_worksheet_cell_set_value(name, sheet_name, cell_name, value=value, type=type, formula=formula, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_worksheet_merge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Merge cells.
    api_response = api_instance.cells_post_worksheet_merge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_post_worksheet_unmerge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Unmerge cells.
    api_response = api_instance.cells_post_worksheet_unmerge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsDocumentPropertiesResponse cells_properties_delete_document_properties(name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete all custom document properties and clean built-in ones.
    api_response = api_instance.cells_properties_delete_document_properties(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsDocumentPropertiesResponse cells_properties_delete_document_property(name, property_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete document property.
    api_response = api_instance.cells_properties_delete_document_property(name, property_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_properties_delete_document_property: %s\n" % e)
```
...
> CellsDocumentPropertiesResponse cells_properties_get_document_properties(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read document properties.
    api_response = api_instance.cells_properties_get_document_properties(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsDocumentPropertyResponse cells_properties_get_document_property(name, property_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read document property by name.
    api_response = api_instance.cells_properties_get_document_property(name, property_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_properties_get_document_property: %s\n" % e)
```
...
> CellsDocumentPropertyResponse cells_properties_put_document_property(name, property_name, _property=_property, folder=folder, storage_name=storage_name)
...
try: 
    # Set/create document property.
    api_response = api_instance.cells_properties_put_document_property(name, property_name, _property=_property, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_properties_put_document_property: %s\n" % e)
```
...
try: 
    # Insert worksheet columns.
    api_response = api_instance.cells_put_insert_worksheet_columns(name, sheet_name, column_index, columns, update_reference=update_reference, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
try: 
    # Insert new worksheet row.
    api_response = api_instance.cells_put_insert_worksheet_row(name, sheet_name, row_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_put_insert_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder, storage_name=storage_name)
...
try: 
    # Insert several new worksheet rows.
    api_response = api_instance.cells_put_insert_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> RangeValueResponse cells_ranges_get_worksheet_cells_range_value(name, sheet_name, namerange=namerange, first_row=first_row, first_column=first_column, row_count=row_count, column_count=column_count, folder=folder, storage_name=storage_name)
...
try: 
    # Get cells list in a range by range name or row column indexes  
    api_response = api_instance.cells_ranges_get_worksheet_cells_range_value(name, sheet_name, namerange=namerange, first_row=first_row, first_column=first_column, row_count=row_count, column_count=column_count, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_get_worksheet_cells_range_value: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_column_width(name, sheet_name, value, range=range, folder=folder, storage_name=storage_name)
...
try: 
    # Set column width of range
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_column_width(name, sheet_name, value, range=range, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_column_width: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_merge(name, sheet_name, range=range, folder=folder, storage_name=storage_name)
...
try: 
    # Combines a range of cells into a single cell.              
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_merge(name, sheet_name, range=range, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_merge: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_move_to(name, sheet_name, dest_row, dest_column, range=range, folder=folder, storage_name=storage_name)
...
try: 
    # Move the current range to the dest range.             
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_move_to(name, sheet_name, dest_row, dest_column, range=range, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_move_to: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_outline_border(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
...
try: 
    # Sets outline border around a range of cells.
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_outline_border(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_outline_border: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_row_height(name, sheet_name, value, range=range, folder=folder, storage_name=storage_name)
...
try: 
    # set row height of range
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_row_height(name, sheet_name, value, range=range, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_row_height: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_style(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
...
try: 
    # Sets the style of the range.             
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_style(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_style: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_unmerge(name, sheet_name, range=range, folder=folder, storage_name=storage_name)
...
try: 
    # Unmerges merged cells of this range.             
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_unmerge(name, sheet_name, range=range, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_unmerge: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_range_value(name, sheet_name, value, range=range, is_converted=is_converted, set_style=set_style, folder=folder, storage_name=storage_name)
...
try: 
    # Puts a value into the range, if appropriate the value will be converted to other data type and cell's number format will be reset.             
    api_response = api_instance.cells_ranges_post_worksheet_cells_range_value(name, sheet_name, value, range=range, is_converted=is_converted, set_style=set_style, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_range_value: %s\n" % e)
```
...
> CellsCloudResponse cells_ranges_post_worksheet_cells_ranges(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
...
try: 
    # copy range in the worksheet
    api_response = api_instance.cells_ranges_post_worksheet_cells_ranges(name, sheet_name, range_operate=range_operate, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_ranges_post_worksheet_cells_ranges: %s\n" % e)
```
...
> SaveResponse cells_save_as_post_document_save_as(name, save_options=save_options, newfilename=newfilename, is_auto_fit_rows=is_auto_fit_rows, is_auto_fit_columns=is_auto_fit_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Convert document and save result to storage.
    api_response = api_instance.cells_save_as_post_document_save_as(name, save_options=save_options, newfilename=newfilename, is_auto_fit_rows=is_auto_fit_rows, is_auto_fit_columns=is_auto_fit_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_save_as_post_document_save_as: %s\n" % e)
```
...
> CellsCloudResponse cells_shapes_delete_worksheet_shape(name, sheet_name, shapeindex, folder=folder, storage_name=storage_name)
...
try: 
    # Delete a shape in worksheet
    api_response = api_instance.cells_shapes_delete_worksheet_shape(name, sheet_name, shapeindex, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_delete_worksheet_shape: %s\n" % e)
```
...
> CellsCloudResponse cells_shapes_delete_worksheet_shapes(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # delete all shapes in worksheet
    api_response = api_instance.cells_shapes_delete_worksheet_shapes(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_delete_worksheet_shapes: %s\n" % e)
```
...
> ShapeResponse cells_shapes_get_worksheet_shape(name, sheet_name, shapeindex, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet shape
    api_response = api_instance.cells_shapes_get_worksheet_shape(name, sheet_name, shapeindex, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_get_worksheet_shape: %s\n" % e)
```
...
> ShapesResponse cells_shapes_get_worksheet_shapes(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet shapes 
    api_response = api_instance.cells_shapes_get_worksheet_shapes(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_get_worksheet_shapes: %s\n" % e)
```
...
> CellsCloudResponse cells_shapes_post_worksheet_shape(name, sheet_name, shapeindex, dto=dto, folder=folder, storage_name=storage_name)
...
try: 
    # Update a shape in worksheet
    api_response = api_instance.cells_shapes_post_worksheet_shape(name, sheet_name, shapeindex, dto=dto, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_post_worksheet_shape: %s\n" % e)
```
...
> ShapeResponse cells_shapes_put_worksheet_shape(name, sheet_name, shape_dto=shape_dto, drawing_type=drawing_type, upper_left_row=upper_left_row, upper_left_column=upper_left_column, top=top, left=left, width=width, height=height, folder=folder, storage_name=storage_name)
...
name = 'name_example' # str | document name.
sheet_name = 'sheet_name_example' # str | worksheet name.
shape_dto = asposecellscloud.Shape() # Shape |  (optional)
drawing_type = 'drawing_type_example' # str | shape object type (optional)
upper_left_row = 56 # int | Upper left row index. (optional)
upper_left_column = 56 # int | Upper left column index. (optional)
top = 56 # int | Represents the vertical offset of Spinner from its left row, in unit of pixel. (optional)
left = 56 # int | Represents the horizontal offset of Spinner from its left column, in unit of pixel. (optional)
width = 56 # int | Represents the height of Spinner, in unit of pixel. (optional)
height = 56 # int | Represents the width of Spinner, in unit of pixel. (optional)
folder = 'folder_example' # str | Document's folder. (optional)
storage_name = 'storage_name_example' # str | storage name. (optional)

try: 
    # Add shape in worksheet
    api_response = api_instance.cells_shapes_put_worksheet_shape(name, sheet_name, shape_dto=shape_dto, drawing_type=drawing_type, upper_left_row=upper_left_row, upper_left_column=upper_left_column, top=top, left=left, width=width, height=height, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_shapes_put_worksheet_shape: %s\n" % e)
```
 ...
 **drawing_type** | **str**| shape object type | [optional] 
...
try: 
    ...
    print("Exception when calling CellsApi->cells_task_post_run_task: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_delete_decrypt_document(name, encryption=encryption, folder=folder, storage_name=storage_name)
...
try: 
    # Decrypt document.
    api_response = api_instance.cells_workbook_delete_decrypt_document(name, encryption=encryption, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_delete_decrypt_document: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_delete_document_unprotect_from_changes(name, folder=folder, storage_name=storage_name)
...
try: 
    # Unprotect document from changes.
    api_response = api_instance.cells_workbook_delete_document_unprotect_from_changes(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_delete_document_unprotect_from_changes: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_delete_unprotect_document(name, protection=protection, folder=folder, storage_name=storage_name)
...
try: 
    # Unprotect document.
    api_response = api_instance.cells_workbook_delete_unprotect_document(name, protection=protection, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_delete_unprotect_document: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_delete_workbook_background(name, folder=folder, storage_name=storage_name)
...
try: 
    # Set worksheet background image.
    api_response = api_instance.cells_workbook_delete_workbook_background(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_workbook_delete_workbook_name(name, name_name, folder=folder, storage_name=storage_name)
...
try: 
    # Clean workbook's names.
    api_response = api_instance.cells_workbook_delete_workbook_name(name, name_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_delete_workbook_name: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_delete_workbook_names(name, folder=folder, storage_name=storage_name)
...
try: 
    # Clean workbook's names.
    api_response = api_instance.cells_workbook_delete_workbook_names(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_delete_workbook_names: %s\n" % e)
```
...
> file cells_workbook_get_workbook(name, password=password, format=format, is_auto_fit=is_auto_fit, only_save_table=only_save_table, folder=folder, storage_name=storage_name, out_path=out_path)
...
try: 
    # Read workbook info or export.
    api_response = api_instance.cells_workbook_get_workbook(name, password=password, format=format, is_auto_fit=is_auto_fit, only_save_table=only_save_table, folder=folder, storage_name=storage_name, out_path=out_path)
    pprint(api_response)
except ApiException as e:
...
> StyleResponse cells_workbook_get_workbook_default_style(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read workbook default style info.
    api_response = api_instance.cells_workbook_get_workbook_default_style(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_default_style: %s\n" % e)
```
...
> NameResponse cells_workbook_get_workbook_name(name, name_name, folder=folder, storage_name=storage_name)
...
try: 
    # Read workbook's name.
    api_response = api_instance.cells_workbook_get_workbook_name(name, name_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_name: %s\n" % e)
```
...
> RangeValueResponse cells_workbook_get_workbook_name_value(name, name_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get workbook's name value.
    api_response = api_instance.cells_workbook_get_workbook_name_value(name, name_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_name_value: %s\n" % e)
```
...
> NamesResponse cells_workbook_get_workbook_names(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read workbook's names.
    api_response = api_instance.cells_workbook_get_workbook_names(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_names: %s\n" % e)
```
...
> WorkbookSettingsResponse cells_workbook_get_workbook_settings(name, folder=folder, storage_name=storage_name)
...
try: 
    # Get Workbook Settings DTO
    api_response = api_instance.cells_workbook_get_workbook_settings(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_settings: %s\n" % e)
```
...
> TextItemsResponse cells_workbook_get_workbook_text_items(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read workbook's text items.
    api_response = api_instance.cells_workbook_get_workbook_text_items(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_get_workbook_text_items: %s\n" % e)
```
...
try: 
    # Autofit workbook rows.
    api_response = api_instance.cells_workbook_post_autofit_workbook_rows(name, auto_fitter_options=auto_fitter_options, start_row=start_row, end_row=end_row, only_auto=only_auto, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_autofit_workbook_rows: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_post_encrypt_document(name, encryption=encryption, folder=folder, storage_name=storage_name)
...
try: 
    # Encript document.
    api_response = api_instance.cells_workbook_post_encrypt_document(name, encryption=encryption, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_encrypt_document: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_post_import_data(name, import_data, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_workbook_post_import_data(name, import_data, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_workbook_post_protect_document(name, protection=protection, folder=folder, storage_name=storage_name)
...
try: 
    # Protect document.
    api_response = api_instance.cells_workbook_post_protect_document(name, protection=protection, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_protect_document: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_post_workbook_calculate_formula(name, options=options, ignore_error=ignore_error, folder=folder, storage_name=storage_name)
...
try: 
    # Calculate all formulas in workbook.
    api_response = api_instance.cells_workbook_post_workbook_calculate_formula(name, options=options, ignore_error=ignore_error, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbook_calculate_formula: %s\n" % e)
```
...
> file cells_workbook_post_workbook_get_smart_marker_result(name, xml_file=xml_file, folder=folder, storage_name=storage_name, out_path=out_path)
...
try: 
    # Smart marker processing result.
    api_response = api_instance.cells_workbook_post_workbook_get_smart_marker_result(name, xml_file=xml_file, folder=folder, storage_name=storage_name, out_path=out_path)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbook_get_smart_marker_result: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_post_workbook_settings(name, settings=settings, folder=folder, storage_name=storage_name)
...
try: 
    # Update Workbook setting 
    api_response = api_instance.cells_workbook_post_workbook_settings(name, settings=settings, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbook_settings: %s\n" % e)
```
...
> SplitResultResponse cells_workbook_post_workbook_split(name, format=format, _from=_from, to=to, horizontal_resolution=horizontal_resolution, vertical_resolution=vertical_resolution, folder=folder, out_folder=out_folder, storage_name=storage_name)
...
try: 
    # Split workbook.
    api_response = api_instance.cells_workbook_post_workbook_split(name, format=format, _from=_from, to=to, horizontal_resolution=horizontal_resolution, vertical_resolution=vertical_resolution, folder=folder, out_folder=out_folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> WorkbookResponse cells_workbook_post_workbooks_merge(name, merge_with, folder=folder, storage_name=storage_name)
...
try: 
    # Merge workbooks.
    api_response = api_instance.cells_workbook_post_workbooks_merge(name, merge_with, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbooks_merge: %s\n" % e)
```
...
> WorkbookReplaceResponse cells_workbook_post_workbooks_text_replace(name, old_value, new_value, folder=folder, storage_name=storage_name)
...
try: 
    # Replace text.
    api_response = api_instance.cells_workbook_post_workbooks_text_replace(name, old_value, new_value, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbooks_text_replace: %s\n" % e)
```
...
> TextItemsResponse cells_workbook_post_workbooks_text_search(name, text, folder=folder, storage_name=storage_name)
...
try: 
    # Search text.
    api_response = api_instance.cells_workbook_post_workbooks_text_search(name, text, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_post_workbooks_text_search: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_put_document_protect_from_changes(name, password=password, folder=folder, storage_name=storage_name)
...
try: 
    # Protect document from changes.
    api_response = api_instance.cells_workbook_put_document_protect_from_changes(name, password=password, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_workbook_put_document_protect_from_changes: %s\n" % e)
```
...
> CellsCloudResponse cells_workbook_put_workbook_background(name, png, folder=folder, storage_name=storage_name)
...
try: 
    # Set workbook background image.
    api_response = api_instance.cells_workbook_put_workbook_background(name, png, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> WorkbookResponse cells_workbook_put_workbook_create(name, template_file=template_file, data_file=data_file, is_write_over=is_write_over, folder=folder, storage_name=storage_name)
...
try: 
    # Create new workbook using deferent methods.
    api_response = api_instance.cells_workbook_put_workbook_create(name, template_file=template_file, data_file=data_file, is_write_over=is_write_over, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> CellsCloudResponse cells_workbook_put_workbook_water_marker(name, folder=folder, storage_name=storage_name, text_water_marker_request=text_water_marker_request)
...
try: 
    # Set workbook background image.
    api_response = api_instance.cells_workbook_put_workbook_water_marker(name, folder=folder, storage_name=storage_name, text_water_marker_request=text_water_marker_request)
    pprint(api_response)
except ApiException as e:
...
> ValidationResponse cells_worksheet_validations_delete_worksheet_validation(name, sheet_name, validation_index, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet validation by index.
    api_response = api_instance.cells_worksheet_validations_delete_worksheet_validation(name, sheet_name, validation_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheet_validations_delete_worksheet_validation: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheet_validations_delete_worksheet_validations(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Clear all validation in worksheet.
    api_response = api_instance.cells_worksheet_validations_delete_worksheet_validations(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> ValidationResponse cells_worksheet_validations_get_worksheet_validation(name, sheet_name, validation_index, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet validation by index.
    api_response = api_instance.cells_worksheet_validations_get_worksheet_validation(name, sheet_name, validation_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheet_validations_get_worksheet_validation: %s\n" % e)
```
...
> ValidationsResponse cells_worksheet_validations_get_worksheet_validations(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet validations.
    api_response = api_instance.cells_worksheet_validations_get_worksheet_validations(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheet_validations_get_worksheet_validations: %s\n" % e)
```
...
> ValidationResponse cells_worksheet_validations_post_worksheet_validation(name, sheet_name, validation_index, validation=validation, folder=folder, storage_name=storage_name)
...
try: 
    # Update worksheet validation by index.
    api_response = api_instance.cells_worksheet_validations_post_worksheet_validation(name, sheet_name, validation_index, validation=validation, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheet_validations_post_worksheet_validation: %s\n" % e)
```
...
> ValidationResponse cells_worksheet_validations_put_worksheet_validation(name, sheet_name, range=range, validation=validation, folder=folder, storage_name=storage_name)
...
validation = asposecellscloud.Validation() # Validation | validation (optional)
folder = 'folder_example' # str | Document's folder. (optional)
storage_name = 'storage_name_example' # str | storage name. (optional)

try: 
    # Add worksheet validation at index.
    api_response = api_instance.cells_worksheet_validations_put_worksheet_validation(name, sheet_name, range=range, validation=validation, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheet_validations_put_worksheet_validation: %s\n" % e)
```
...
> WorksheetResponse cells_worksheets_delete_unprotect_worksheet(name, sheet_name, protect_parameter=protect_parameter, folder=folder, storage_name=storage_name)
...
try: 
    # Unprotect worksheet.
    api_response = api_instance.cells_worksheets_delete_unprotect_worksheet(name, sheet_name, protect_parameter=protect_parameter, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_unprotect_worksheet: %s\n" % e)
```
...
> WorksheetsResponse cells_worksheets_delete_worksheet(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet.
    api_response = api_instance.cells_worksheets_delete_worksheet(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_worksheet: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_delete_worksheet_background(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Set worksheet background image.
    api_response = api_instance.cells_worksheets_delete_worksheet_background(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_worksheet_background: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_delete_worksheet_comment(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete worksheet's cell comment.
    api_response = api_instance.cells_worksheets_delete_worksheet_comment(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_worksheet_comment: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_delete_worksheet_comments(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Delete all comments for worksheet.
    api_response = api_instance.cells_worksheets_delete_worksheet_comments(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_worksheet_comments: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_delete_worksheet_freeze_panes(name, sheet_name, row, column, freezed_rows, freezed_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Unfreeze panes
    api_response = api_instance.cells_worksheets_delete_worksheet_freeze_panes(name, sheet_name, row, column, freezed_rows, freezed_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_delete_worksheet_freeze_panes: %s\n" % e)
```
...
> RangesResponse cells_worksheets_get_named_ranges(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheets ranges info.
    api_response = api_instance.cells_worksheets_get_named_ranges(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_named_ranges: %s\n" % e)
```
...
> file cells_worksheets_get_worksheet(name, sheet_name, format=format, vertical_resolution=vertical_resolution, horizontal_resolution=horizontal_resolution, area=area, page_index=page_index, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheet info or export.
    api_response = api_instance.cells_worksheets_get_worksheet(name, sheet_name, format=format, vertical_resolution=vertical_resolution, horizontal_resolution=horizontal_resolution, area=area, page_index=page_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
...
> SingleValueResponse cells_worksheets_get_worksheet_calculate_formula(name, sheet_name, formula, folder=folder, storage_name=storage_name)
...
try: 
    # Calculate formula value.
    api_response = api_instance.cells_worksheets_get_worksheet_calculate_formula(name, sheet_name, formula, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_calculate_formula: %s\n" % e)
```
...
> CommentResponse cells_worksheets_get_worksheet_comment(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet comment by cell name.
    api_response = api_instance.cells_worksheets_get_worksheet_comment(name, sheet_name, cell_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_comment: %s\n" % e)
```
...
> CommentsResponse cells_worksheets_get_worksheet_comments(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet comments.
    api_response = api_instance.cells_worksheets_get_worksheet_comments(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_comments: %s\n" % e)
```
...
> MergedCellResponse cells_worksheets_get_worksheet_merged_cell(name, sheet_name, merged_cell_index, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet merged cell by its index.
    api_response = api_instance.cells_worksheets_get_worksheet_merged_cell(name, sheet_name, merged_cell_index, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_merged_cell: %s\n" % e)
```
...
> MergedCellsResponse cells_worksheets_get_worksheet_merged_cells(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet merged cells.
    api_response = api_instance.cells_worksheets_get_worksheet_merged_cells(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_merged_cells: %s\n" % e)
```
...
> TextItemsResponse cells_worksheets_get_worksheet_text_items(name, sheet_name, folder=folder, storage_name=storage_name)
...
try: 
    # Get worksheet text items.
    api_response = api_instance.cells_worksheets_get_worksheet_text_items(name, sheet_name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheet_text_items: %s\n" % e)
```
...
> WorksheetsResponse cells_worksheets_get_worksheets(name, folder=folder, storage_name=storage_name)
...
try: 
    # Read worksheets info.
    api_response = api_instance.cells_worksheets_get_worksheets(name, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_get_worksheets: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_autofit_worksheet_columns(name, sheet_name, first_column, last_column, auto_fitter_options=auto_fitter_options, first_row=first_row, last_row=last_row, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_worksheets_post_autofit_worksheet_columns(name, sheet_name, first_column, last_column, auto_fitter_options=auto_fitter_options, first_row=first_row, last_row=last_row, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_autofit_worksheet_columns: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_autofit_worksheet_row(name, sheet_name, row_index, first_column, last_column, auto_fitter_options=auto_fitter_options, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_worksheets_post_autofit_worksheet_row(name, sheet_name, row_index, first_column, last_column, auto_fitter_options=auto_fitter_options, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_autofit_worksheet_row: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_autofit_worksheet_rows(name, sheet_name, auto_fitter_options=auto_fitter_options, start_row=start_row, end_row=end_row, only_auto=only_auto, folder=folder, storage_name=storage_name)
...
try: 
    # Autofit worksheet rows.
    api_response = api_instance.cells_worksheets_post_autofit_worksheet_rows(name, sheet_name, auto_fitter_options=auto_fitter_options, start_row=start_row, end_row=end_row, only_auto=only_auto, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_autofit_worksheet_rows: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_copy_worksheet(name, sheet_name, source_sheet, options=options, source_workbook=source_workbook, source_folder=source_folder, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_worksheets_post_copy_worksheet(name, sheet_name, source_sheet, options=options, source_workbook=source_workbook, source_folder=source_folder, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_copy_worksheet: %s\n" % e)
```
...
> WorksheetsResponse cells_worksheets_post_move_worksheet(name, sheet_name, moving=moving, folder=folder, storage_name=storage_name)
...
try: 
    # Move worksheet.
    api_response = api_instance.cells_worksheets_post_move_worksheet(name, sheet_name, moving=moving, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_move_worksheet: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_rename_worksheet(name, sheet_name, newname, folder=folder, storage_name=storage_name)
...
try: 
    # Rename worksheet
    api_response = api_instance.cells_worksheets_post_rename_worksheet(name, sheet_name, newname, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_rename_worksheet: %s\n" % e)
```
...
> WorksheetResponse cells_worksheets_post_update_worksheet_property(name, sheet_name, sheet=sheet, folder=folder, storage_name=storage_name)
...
try: 
    # Update worksheet property
    api_response = api_instance.cells_worksheets_post_update_worksheet_property(name, sheet_name, sheet=sheet, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_update_worksheet_property: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_update_worksheet_zoom(name, sheet_name, value, folder=folder, storage_name=storage_name)
...
try: 
    api_response = api_instance.cells_worksheets_post_update_worksheet_zoom(name, sheet_name, value, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_update_worksheet_zoom: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_worksheet_comment(name, sheet_name, cell_name, comment=comment, folder=folder, storage_name=storage_name)
...
try: 
    # Update worksheet's cell comment.
    api_response = api_instance.cells_worksheets_post_worksheet_comment(name, sheet_name, cell_name, comment=comment, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_worksheet_comment: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_post_worksheet_range_sort(name, sheet_name, cell_area, data_sorter=data_sorter, folder=folder, storage_name=storage_name)
...
try: 
    # Sort worksheet range.
    api_response = api_instance.cells_worksheets_post_worksheet_range_sort(name, sheet_name, cell_area, data_sorter=data_sorter, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_worksheet_range_sort: %s\n" % e)
```
...
> TextItemsResponse cells_worksheets_post_worksheet_text_search(name, sheet_name, text, folder=folder, storage_name=storage_name)
...
try: 
    # Search text.
    api_response = api_instance.cells_worksheets_post_worksheet_text_search(name, sheet_name, text, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_worksheet_text_search: %s\n" % e)
```
...
> WorksheetReplaceResponse cells_worksheets_post_worsheet_text_replace(name, sheet_name, old_value, new_value, folder=folder, storage_name=storage_name)
...
try: 
    # Replace text.
    api_response = api_instance.cells_worksheets_post_worsheet_text_replace(name, sheet_name, old_value, new_value, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_post_worsheet_text_replace: %s\n" % e)
```
...
> WorksheetsResponse cells_worksheets_put_add_new_worksheet(name, sheet_name, position=position, sheettype=sheettype, folder=folder, storage_name=storage_name)
...
try: 
    # Add new worksheet.
    api_response = api_instance.cells_worksheets_put_add_new_worksheet(name, sheet_name, position=position, sheettype=sheettype, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_add_new_worksheet: %s\n" % e)
```
...
> WorksheetResponse cells_worksheets_put_change_visibility_worksheet(name, sheet_name, is_visible, folder=folder, storage_name=storage_name)
...
try: 
    # Change worksheet visibility.
    api_response = api_instance.cells_worksheets_put_change_visibility_worksheet(name, sheet_name, is_visible, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_change_visibility_worksheet: %s\n" % e)
```
...
> WorksheetResponse cells_worksheets_put_protect_worksheet(name, sheet_name, protect_parameter=protect_parameter, folder=folder, storage_name=storage_name)
...
try: 
    # Protect worksheet.
    api_response = api_instance.cells_worksheets_put_protect_worksheet(name, sheet_name, protect_parameter=protect_parameter, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_protect_worksheet: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_put_worksheet_background(name, sheet_name, png, folder=folder, storage_name=storage_name)
...
try: 
    # Set worksheet background image.
    api_response = api_instance.cells_worksheets_put_worksheet_background(name, sheet_name, png, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_worksheet_background: %s\n" % e)
```
...
> CommentResponse cells_worksheets_put_worksheet_comment(name, sheet_name, cell_name, comment=comment, folder=folder, storage_name=storage_name)
...
try: 
    # Add worksheet's cell comment.
    api_response = api_instance.cells_worksheets_put_worksheet_comment(name, sheet_name, cell_name, comment=comment, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_worksheet_comment: %s\n" % e)
```
...
> CellsCloudResponse cells_worksheets_put_worksheet_freeze_panes(name, sheet_name, row, column, freezed_rows, freezed_columns, folder=folder, storage_name=storage_name)
...
try: 
    # Set freeze panes
    api_response = api_instance.cells_worksheets_put_worksheet_freeze_panes(name, sheet_name, row, column, freezed_rows, freezed_columns, folder=folder, storage_name=storage_name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CellsApi->cells_worksheets_put_worksheet_freeze_panes: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->copy_file: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->copy_folder: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->create_folder: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->delete_file: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->delete_folder: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->download_file: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->get_disc_usage: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->get_file_versions: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->get_files_list: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->move_file: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->move_folder: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->o_auth_post: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->object_exists: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->storage_exists: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling CellsApi->upload_file: %s\n" % e)
```

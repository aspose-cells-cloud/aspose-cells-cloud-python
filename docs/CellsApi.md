...
> ColumnsResponse cells_delete_worksheet_columns(name, sheet_name, column_index, columns, update_reference, folder=folder)
...
> SaaSposeResponse cells_delete_worksheet_row(name, sheet_name, row_index, folder=folder)
...
try: 
    # Delete worksheet row.
    api_response = api_instance.cells_delete_worksheet_row(name, sheet_name, row_index, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_delete_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder)
...
try: 
    # Delete several worksheet rows.
    api_response = api_instance.cells_delete_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> file cells_get_worksheet_cell(name, sheet_name, cell_or_method_name, folder=folder)
...
try: 
    # Read cell data by cell's name.
    api_response = api_instance.cells_get_worksheet_cell(name, sheet_name, cell_or_method_name, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> StyleResponse cells_get_worksheet_cell_style(name, sheet_name, cell_name, folder=folder)
...
try: 
    # Read cell's style info.
    api_response = api_instance.cells_get_worksheet_cell_style(name, sheet_name, cell_name, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> CellsResponse cells_get_worksheet_cells(name, sheet_name, offest=offest, count=count, folder=folder)
...
try: 
    # Get cells info.
    api_response = api_instance.cells_get_worksheet_cells(name, sheet_name, offest=offest, count=count, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> ColumnResponse cells_get_worksheet_column(name, sheet_name, column_index, folder=folder)
...
try: 
    # Read worksheet column data by column's index.
    api_response = api_instance.cells_get_worksheet_column(name, sheet_name, column_index, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> ColumnsResponse cells_get_worksheet_columns(name, sheet_name, folder=folder)
...
try: 
    # Read worksheet columns info.
    api_response = api_instance.cells_get_worksheet_columns(name, sheet_name, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> RowResponse cells_get_worksheet_row(name, sheet_name, row_index, folder=folder)
...
try: 
    # Read worksheet row data by row's index.
    api_response = api_instance.cells_get_worksheet_row(name, sheet_name, row_index, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> RowsResponse cells_get_worksheet_rows(name, sheet_name, folder=folder)
...
try: 
    # Read worksheet rows info.
    api_response = api_instance.cells_get_worksheet_rows(name, sheet_name, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_cell_calculate(name, sheet_name, cell_name, options=options, folder=folder)
...
try: 
    # Cell calculate formula
    api_response = api_instance.cells_post_cell_calculate(name, sheet_name, cell_name, options=options, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_cell_characters(name, sheet_name, cell_name, options=options, folder=folder)
...
try: 
    # Set cell characters 
    api_response = api_instance.cells_post_cell_characters(name, sheet_name, cell_name, options=options, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_clear_contents(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder)
...
try: 
    # Clear cells contents.
    api_response = api_instance.cells_post_clear_contents(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_clear_formats(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder)
...
try: 
    # Clear cells contents.
    api_response = api_instance.cells_post_clear_formats(name, sheet_name, range=range, start_row=start_row, start_column=start_column, end_row=end_row, end_column=end_column, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_column_style(name, sheet_name, column_index, style=style, folder=folder)
...
try: 
    # Set column style
    api_response = api_instance.cells_post_column_style(name, sheet_name, column_index, style=style, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_copy_cell_into_cell(name, dest_cell_name, sheet_name, worksheet, cellname=cellname, row=row, column=column, folder=folder)
...
try: 
    # Copy cell into cell
    api_response = api_instance.cells_post_copy_cell_into_cell(name, dest_cell_name, sheet_name, worksheet, cellname=cellname, row=row, column=column, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_copy_worksheet_columns(name, sheet_name, source_column_index, destination_column_index, column_number, worksheet=worksheet, folder=folder)
...
try: 
    # Copy worksheet columns.
    api_response = api_instance.cells_post_copy_worksheet_columns(name, sheet_name, source_column_index, destination_column_index, column_number, worksheet=worksheet, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_copy_worksheet_rows(name, sheet_name, source_row_index, destination_row_index, row_number, worksheet=worksheet, folder=folder)
...
try: 
    # Copy worksheet rows.
    api_response = api_instance.cells_post_copy_worksheet_rows(name, sheet_name, source_row_index, destination_row_index, row_number, worksheet=worksheet, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_group_worksheet_columns(name, sheet_name, first_index, last_index, hide=hide, folder=folder)
...
try: 
    # Group worksheet columns.
    api_response = api_instance.cells_post_group_worksheet_columns(name, sheet_name, first_index, last_index, hide=hide, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_group_worksheet_rows(name, sheet_name, first_index, last_index, hide=hide, folder=folder)
...
try: 
    # Group worksheet rows.
    api_response = api_instance.cells_post_group_worksheet_rows(name, sheet_name, first_index, last_index, hide=hide, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_hide_worksheet_columns(name, sheet_name, start_column, total_columns, folder=folder)
...
try: 
    # Hide worksheet columns.
    api_response = api_instance.cells_post_hide_worksheet_columns(name, sheet_name, start_column, total_columns, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_hide_worksheet_rows(name, sheet_name, startrow, total_rows, folder=folder)
...
try: 
    # Hide worksheet rows.
    api_response = api_instance.cells_post_hide_worksheet_rows(name, sheet_name, startrow, total_rows, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_row_style(name, sheet_name, row_index, style=style, folder=folder)
...
try: 
    # Set row style.
    api_response = api_instance.cells_post_row_style(name, sheet_name, row_index, style=style, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> CellResponse cells_post_set_cell_html_string(name, sheet_name, cell_name, folder=folder)
...
try: 
    # Set htmlstring value into cell
    api_response = api_instance.cells_post_set_cell_html_string(name, sheet_name, cell_name, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_set_cell_range_value(name, sheet_name, cellarea, value, type, folder=folder)
...
try: 
    # Set cell range value 
    api_response = api_instance.cells_post_set_cell_range_value(name, sheet_name, cellarea, value, type, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> ColumnResponse cells_post_set_worksheet_column_width(name, sheet_name, column_index, width, folder=folder)
...
try: 
    # Set worksheet column width.
    api_response = api_instance.cells_post_set_worksheet_column_width(name, sheet_name, column_index, width, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_ungroup_worksheet_columns(name, sheet_name, first_index, last_index, folder=folder)
...
try: 
    # Ungroup worksheet columns.
    api_response = api_instance.cells_post_ungroup_worksheet_columns(name, sheet_name, first_index, last_index, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_ungroup_worksheet_rows(name, sheet_name, first_index, last_index, is_all=is_all, folder=folder)
...
try: 
    # Ungroup worksheet rows.
    api_response = api_instance.cells_post_ungroup_worksheet_rows(name, sheet_name, first_index, last_index, is_all=is_all, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_unhide_worksheet_columns(name, sheet_name, startcolumn, total_columns, width=width, folder=folder)
...
try: 
    # Unhide worksheet columns.
    api_response = api_instance.cells_post_unhide_worksheet_columns(name, sheet_name, startcolumn, total_columns, width=width, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_unhide_worksheet_rows(name, sheet_name, startrow, total_rows, height=height, folder=folder)
...
try: 
    # Unhide worksheet rows.
    api_response = api_instance.cells_post_unhide_worksheet_rows(name, sheet_name, startrow, total_rows, height=height, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> StyleResponse cells_post_update_worksheet_cell_style(name, sheet_name, cell_name, style=style, folder=folder)
...
try: 
    # Update cell's style.
    api_response = api_instance.cells_post_update_worksheet_cell_style(name, sheet_name, cell_name, style=style, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_update_worksheet_range_style(name, sheet_name, range, style=style, folder=folder)
...
try: 
    # Update cell's range style.
    api_response = api_instance.cells_post_update_worksheet_range_style(name, sheet_name, range, style=style, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> RowResponse cells_post_update_worksheet_row(name, sheet_name, row_index, height=height, folder=folder)
...
try: 
    # Update worksheet row.
    api_response = api_instance.cells_post_update_worksheet_row(name, sheet_name, row_index, height=height, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> CellResponse cells_post_worksheet_cell_set_value(name, sheet_name, cell_name, value=value, type=type, formula=formula, folder=folder)
...
try: 
    # Set cell value.
    api_response = api_instance.cells_post_worksheet_cell_set_value(name, sheet_name, cell_name, value=value, type=type, formula=formula, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_worksheet_merge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder)
...
try: 
    # Merge cells.
    api_response = api_instance.cells_post_worksheet_merge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_post_worksheet_unmerge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder)
...
try: 
    # Unmerge cells.
    api_response = api_instance.cells_post_worksheet_unmerge(name, sheet_name, start_row, start_column, total_rows, total_columns, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> ColumnsResponse cells_put_insert_worksheet_columns(name, sheet_name, column_index, columns, update_reference=update_reference, folder=folder)
...
try: 
    # Insert worksheet columns.
    api_response = api_instance.cells_put_insert_worksheet_columns(name, sheet_name, column_index, columns, update_reference=update_reference, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> RowResponse cells_put_insert_worksheet_row(name, sheet_name, row_index, folder=folder)
...
try: 
    # Insert new worksheet row.
    api_response = api_instance.cells_put_insert_worksheet_row(name, sheet_name, row_index, folder=folder)
    pprint(api_response)
except ApiException as e:
...
> SaaSposeResponse cells_put_insert_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder)
...
try: 
    # Insert several new worksheet rows.
    api_response = api_instance.cells_put_insert_worksheet_rows(name, sheet_name, startrow, total_rows=total_rows, update_reference=update_reference, folder=folder)
    pprint(api_response)
except ApiException as e:

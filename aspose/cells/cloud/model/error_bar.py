...
class ErrorBar:
    ...
    minus_value: Optional[str] = None
    plus_value: Optional[str] = None
    show_marker_t_top: Optional[bool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.minus_value is not None:
            result["MinusValue"] = self.minus_value
        if self.plus_value is not None:
            result["PlusValue"] = self.plus_value
        if self.show_marker_t_top is not None:
            result["ShowMarkerTTop"] = self.show_marker_t_top

...
class Picture:
    ...
    border_line_color: Optional[Color] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        if self.border_line_color is not None:
            result["BorderLineColor"] = self.border_line_color.to_dict()
        if self.border_weight is not None:
            result["BorderWeight"] = self.border_weight

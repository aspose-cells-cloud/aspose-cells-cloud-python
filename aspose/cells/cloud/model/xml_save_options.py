...
class XmlSaveOptions:
    """XmlSaveOptions."""
    sheet_indexes: Optional[List[int]] = None
    export_area: Optional[CellArea] = None
    has_header_row: Optional[bool] = None
    xml_map_name: Optional[str] = None
    sheet_name_as_element_name: Optional[bool] = None
    data_as_attribute: Optional[bool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.sheet_indexes is not None:
            result["SheetIndexes"] = self.sheet_indexes
        ...
        if self.xml_map_name is not None:
            result["XmlMapName"] = self.xml_map_name
        if self.sheet_name_as_element_name is not None:
            result["SheetNameAsElementName"] = self.sheet_name_as_element_name
        if self.data_as_attribute is not None:
            result["DataAsAttribute"] = self.data_as_attribute

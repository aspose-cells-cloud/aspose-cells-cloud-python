...
class OleObject:
    ...
    display_as_icon: Optional[bool] = None
    file_format_type: Optional[str] = None
    image_source_full_name: Optional[str] = None
    is_auto_size: Optional[bool] = None
    is_link: Optional[bool] = None
    prog_id: Optional[str] = None
    source_full_name: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        if self.display_as_icon is not None:
            result["DisplayAsIcon"] = self.display_as_icon
        if self.file_format_type is not None:
            result["FileFormatType"] = self.file_format_type
        if self.image_source_full_name is not None:
            result["ImageSourceFullName"] = self.image_source_full_name
        if self.is_auto_size is not None:
            result["IsAutoSize"] = self.is_auto_size
        if self.is_link is not None:
            result["IsLink"] = self.is_link
        if self.prog_id is not None:
            result["ProgID"] = self.prog_id
        if self.source_full_name is not None:
            result["SourceFullName"] = self.source_full_name

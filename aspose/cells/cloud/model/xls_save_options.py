...
class XlsSaveOptions:
    ...
    wps_compatibility: Optional[bool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.match_color is not None:
            result["MatchColor"] = self.match_color
        if self.wps_compatibility is not None:
            result["WpsCompatibility"] = self.wps_compatibility

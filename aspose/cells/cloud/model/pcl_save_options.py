...
class PclSaveOptions:
    ...
    font_pcl_name: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        if self.font_full_name is not None:
            result["fontFullName"] = self.font_full_name
        if self.font_pcl_name is not None:
            result["fontPclName"] = self.font_pcl_name

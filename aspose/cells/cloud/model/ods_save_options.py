...
class OdsSaveOptions:
    ...
    odf_strict_version: Optional[str] = None
    ignore_pivot_tables: Optional[bool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.generator_type is not None:
            result["GeneratorType"] = self.generator_type
        if self.odf_strict_version is not None:
            result["OdfStrictVersion"] = self.odf_strict_version
        if self.ignore_pivot_tables is not None:
            result["IgnorePivotTables"] = self.ignore_pivot_tables

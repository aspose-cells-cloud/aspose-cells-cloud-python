...
class PostWorkbookImportJsonRequest(RequestOption):
    ...
    def __init__(
        ...
        if import_json_request is None:
            raise ValueError("importJsonRequest is required")
        self.name = name
    ...
    def get_json_body(self) -> Optional[Any]:
        return self.import_json_request.to_dict()

...
class PostPivotTableUpdatePivotFieldRequest(RequestOption):
    ...
    def __init__(
        ...
        if pivot_field is None:
            raise ValueError("pivotField is required")
        self.name = name
    ...
    def get_path(self) -> str:
        return (
            ...
            "/PivotFields/" +
            quote(str(self.pivot_field_index), safe="/")
        )
    ...
    def get_json_body(self) -> Optional[Any]:
        return self.pivot_field.to_dict()

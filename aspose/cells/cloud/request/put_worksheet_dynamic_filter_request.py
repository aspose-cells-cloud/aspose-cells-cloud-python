...
class PutWorksheetDynamicFilterRequest(RequestOption):
    ...
    def __init__(
        ...
        if not dynamic_filter_type:
            raise ValueError("dynamicFilterType is required")
        self.name = name
    ...
    def get_query_parameters(self) -> Dict[str, str]:
        ...
        params["dynamicFilterType"] = self.dynamic_filter_type

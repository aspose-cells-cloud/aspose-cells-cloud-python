...
class ImportCSVDataIntoSpreadsheetRequest(RequestOption):
    ...
    def get_path(self) -> str:
        return "/v4.0/cells/import/data/csv"
    ...
    def get_query_parameters(self) -> Dict[str, str]:
        ...
        if self.convert_numeric_data is not None:
            params["convertNumericData"] = "true" if self.convert_numeric_data else "false"
        if self.splitter:
            params["splitter"] = self.splitter
        if self.out_path:

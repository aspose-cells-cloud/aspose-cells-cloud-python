...
class Font(object):
    ...
    def __init__(self, color=None, double_size=None, is_bold=None, is_italic=None, is_strikeout=None, is_subscript=None, is_superscript=None, name=None, size=None, underline=None):
        """

...
class SplitResultResponse(SaaSposeResponse):
    ...
    def get_swagger_types(self):
        return dict(SplitResultResponse.swagger_types, **SaaSposeResponse.get_swagger_types(self))
        
    def get_attribute_map(self):
        return dict(SplitResultResponse.attribute_map, **SaaSposeResponse.get_attribute_map(self))

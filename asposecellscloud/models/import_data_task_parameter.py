...
class ImportDataTaskParameter(TaskParameter):
    ...
    def get_swagger_types(self):
        return dict(ImportDataTaskParameter.swagger_types, **TaskParameter.get_swagger_types(self))
        
    def get_attribute_map(self):
        return dict(ImportDataTaskParameter.attribute_map, **TaskParameter.get_attribute_map(self))
    ...
    def __init__(self, workbook=None, import_option=None, destination_workbook=None):
        """

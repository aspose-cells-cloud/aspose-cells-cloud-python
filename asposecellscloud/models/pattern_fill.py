...
class PatternFill(object):
    ...
    def __init__(self, pattern=None, background_cells_color=None, foreground_cells_color=None, foreground_color=None, background_color=None, back_transparency=None, fore_transparency=None):
        """
